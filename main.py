...
class MainWindow(QMainWindow):
    ...
    def fuse_LV(self):
        ...
        if self.ui.ppn_1250.isChecked():
            fuse_func = aDouble()
            ppn = ([20000, 1], [10000, 16], [9000, 20], [8000, 30.3], [7000, 50], [6000, 84], [5000, 180], [4000, 427],
                   [3000, 1800, [2200, 10000])
            for i in ppn:
        ...
        if self.ui.ppn_125.isChecked():
            fuse_func = aDouble()
            ppn = ([3000, 0.01], [2000, 0.038], [1000, 0.5], [900, 0.76], [800, 1.4], [700, 2.43],
                   [600, 5], [500, 10], [400, 19.9], [300, 140], [200, 1940])
            for i in ppn:
                fuse_func.append(i[0] * 0.015)
                fuse_func.append(c * math.log(i[1]) + d)
                fuse_func.append(0)
