...
class MainWindow(QMainWindow):
    ...
    def fuse_MV(self):
        ...
        if self.ui.pkt_10.isChecked():
            pkt = ([300, 0.01], [200, 0.028], [100, 0.14], [90, 0.17], [90, 0.17], [80, 0.23], [70, 0.33], [60, 0.5], [50, 0.9], [40, 2.4], [30, 25], [24, 600])
            for i in pkt:
        ...
        if self.ui.pkt_16.isChecked():
            pkt = ([430, 0.01], [400, 0.013], [300, 0.024], [200, 0.06], [200, 0.06], [100, 0.35], [90, 0.46], [80, 0.75], [70, 1.35], [60, 3], [50, 15.5], [40, 145], [35, 600])
            for i in pkt:
                fuse_func.append(i[0] * 25 * 0.015)
                fuse_func.append(c * math.log(i[1]) + d)
                fuse_func.append(0)
        ...
        if self.ui.pkt_20.isChecked():
            pkt = ([600, 0.01], [500, 0.016], [400, 0.026], [300, 0.048], [300, 0.048], [200, 0.133], [100, 1.15], [90, 2], [80, 4], [70, 10], [60, 35], [50, 170], [44, 600])
            for i in pkt:
                fuse_func.append(i[0] * 25 * 0.015)
                fuse_func.append(c * math.log(i[1]) + d)
                fuse_func.append(0)
        ...
        if self.ui.pkt_31_5.isChecked():
            pkt = ([870, 0.01], [800, 0.014], [700, 0.018], [600, 0.024], [600, 0.024], [500, 0.035], [400, 0.06], [300, 0.115], [200, 0.3], [100, 9], [90, 23], [80, 275], [65, 600])
            for i in pkt:
                fuse_func.append(i[0] * 25 * 0.015)
                fuse_func.append(c * math.log(i[1]) + d)
                fuse_func.append(0)
        ...
        if self.ui.pkt_40.isChecked():
            pkt = ([1250, 0.01], [1000, 0.015], [900, 0.0185], [800, 0.024], [800, 0.024], [700, 0.033], [600, 0.044], [500, 0.065], [400, 0.11], [300, 0.21], [200, 165], [100, 460], [85, 600])
            for i in pkt:
                fuse_func.append(i[0] * 25 * 0.015)
                fuse_func.append(c * math.log(i[1]) + d)
                fuse_func.append(0)
        ...
        if self.ui.pkt_50.isChecked():
            pkt = ([1600, 0.01], [1000, 0.28], [900, 0.33], [800, 0.43], [800, 0.43], [700, 0.06], [600, 0.08], [500, 0.125], [400, 0.2], [300, 0.4], [200, 2], [110, 600])
            for i in pkt:
                fuse_func.append(i[0] * 25 * 0.015)
                fuse_func.append(c * math.log(i[1]) + d)
                fuse_func.append(0)
        ...
        if self.ui.pkt_80.isChecked():
            pkt = ([2360, 0.01], [2000, 0.0155], [1000, 0.07], [900, 0.084], [900, 0.084], [800, 0.11], [700, 0.155], [600, 0.23], [500, 0.36], [400, 0.8], [300, 4], [200, 200], [185, 600])
            for i in pkt:
                fuse_func.append(i[0] * 25 * 0.015)
                fuse_func.append(c * math.log(i[1]) + d)
                fuse_func.append(0)
        ...
        if self.ui.pkt_100.isChecked():
            pkt = ([3100, 0.01], [2000, 0.0275], [1000, 0.145], [900, 0.17], [900, 0.17], [800, 0.24], [700, 0.33], [600, 0.5], [500, 0.9], [400, 2.6], [300, 30], [230, 600])
            for i in pkt:
                fuse_func.append(i[0] * 25 * 0.015)
                fuse_func.append(c * math.log(i[1]) + d)
                fuse_func.append(0)
        ...
        if self.ui.pkt_160.isChecked():
            pkt = ([4800, 0.01], [4000, 0.015], [3000, 0.03], [2000, 0.07], [2000, 0.07], [1000, 0.4], [900, 0.54], [800, 0.8], [700, 1.5], [600, 3.3], [500, 20], [400, 200], [360, 600])
            for i in pkt:
                fuse_func.append(i[0] * 25 * 0.015)
                fuse_func.append(c * math.log(i[1]) + d)
                fuse_func.append(0)
    ...
    def RTV-1(self):
        if self.ui.I1_edit.text() and self.ui.T1_edit.text():
            ...
            I_rtv1 = [1, 1.01, 1.05, 1.1, 1.5, 2, 2.5, 24000/IRTV1]
            ...
            leader_line_RTV1_p1x = IRTV1 * I[3] * 25 * 0.015
            leader_line_RTV1_func.append(leader_line_RTV1_p1x)
            leader_line_RTV1_p1y = TRTV1 + 1 / (30 * ((I[3] - 1) ** 3)) 
            leader_line_RTV1_func.append(c * math.log(leader_line_RTV1_p1y) + d)
            leader_line_RTV1_func.append(0)

            leader_line_RTV1_p2x = p1x + 7.5
            leader_line_RTV1_func.append(leader_line_RTV1_p2x)
            leader_line_RTV1_p2y = leader_line_RTV1_p1y + 7.5
            leader_line_RTV1_func.append(c * math.log(leader_line_RTV1_p2y) + d)
            leader_line_RTV1_func.append(0)
            ...
            #leader_circe_RTV1_cntrX = (leader_circe_RTV1_rad ** 2 / 2) ** 0.5
            leader_circe_RTV1_cntrX = leader_line_RTV1_p2x + 3.18198051533946 #check how it combined
            leader_circe_RTV1_cntrY = leader_line_RTV1_p2y + 3.18198051533946 #check how it combined
    ...
    def RTV-4(self):
        if self.ui.I4_edit.text() and self.ui.T4_edit.text():
            ...
            leader_circe_RTV1_cntrX = leader_line_RTV4_p2x + 3.18198051533946 #check how it combined
            leader_circe_RTV1_cntrY = leader_line_RTV4_p2y + 3.18198051533946 #check how it combined
